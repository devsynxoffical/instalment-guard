...
export const ContractModel = sequelize.define('Contract', {
  ...
  retailerId: { type: DataTypes.STRING, defaultValue: 'RET-644' },
  totalPrice: { type: DataTypes.FLOAT, defaultValue: 0 },
  downPayment: { type: DataTypes.FLOAT, defaultValue: 0 },
  ...
  nextDueDate: { type: DataTypes.STRING, defaultValue: '' },
  paidMonths: { type: DataTypes.INTEGER, defaultValue: 0 },
  totalMonths: { type: DataTypes.INTEGER, defaultValue: 0 },
  status: { type: DataTypes.STRING, defaultValue: 'ACTIVE' },
